package org.kayteam.discordutil;
...
public class DiscordUtil {
    ...
    public static WebhookClient getWebhookClient(String webhookUrl) {
        WebhookClientBuilder builder = new WebhookClientBuilder(webhookUrl); // or id, token
        return builder.build();
    }

    public static WebhookEmbed getWebhookEmbedFromFile(SimpleYaml file, String path){
    ...
    public static WebhookEmbed getWebhookEmbedFromFile(SimpleYaml file, String path, String[][] replacements){
        OffsetDateTime offsetDateTime = null;
        Integer color = null;
        String description = null;
        String thumbnailUrl = null;
    ...
    public static EmbedBuilder getEmbedFromFile(SimpleYaml file, String path){
    ...
    public static EmbedBuilder getEmbedFromFile(SimpleYaml file, String path, String[][] replacements){
        EmbedBuilder embedBuilder = new EmbedBuilder();
        if(file.contains(path+".authorName")){
            String authorIcon = null;
            String authorUrl = null;
